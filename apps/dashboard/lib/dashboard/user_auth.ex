defmodule Dashboard.UserAuth do
  ...
  @doc """
  Authenticates the user by looking into the session. We're currently not implementing
  remember me on the front-end. Should that change, we'll need to add it if the access_tokens
  do not match.
  """
